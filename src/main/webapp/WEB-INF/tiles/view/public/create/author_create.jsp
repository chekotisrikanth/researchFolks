...
<body>
<h1><spring:message code="author.create"/></h1>
<form:form method="POST" action="/public/author_create.html" commandName="form" modelAttribute="form">
    ...
    <div>
        <form:label path="biodata"><spring:message code="author.biodata"/></form:label>
        <form:input path="biodata"/>
        <form:errors path="biodata"/>
    </div>
    
    <div>
        <form:label path="keyskills"><spring:message code="author.keyskills"/></form:label>
         <form:select multiple="true" path="keyskills">
					  <form:option value="" label="--- Select ---" />
					  <form:options items="${keyskills}" itemValue="id" itemLabel="skill" />
		</form:select>
        <form:errors path="keyskills"/>
    </div>
    
    <div>
        <form:label path="isAgreedTC"><spring:message code="user.isAgreedTC"/></form:label>
