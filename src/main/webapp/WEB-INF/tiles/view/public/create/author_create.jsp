...
<form:form enctype="multipart/form-data" method="POST" class="form-horizontal alignHCenter " action="${pageContext.request.contextPath}/public/author_create.html" commandName="form" modelAttribute="form">
